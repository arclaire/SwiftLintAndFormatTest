...
class IScreen1: NSObject {
	...
	func configureURLSearch(str: String) -> String {
		...
		strUrl += "function=SYMBOL_SEARCH"

		let paramSymbol = str
		strUrl += "&keywords=" + paramSymbol
